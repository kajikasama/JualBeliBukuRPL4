      ...
      <div class="container">
        <div class="nav-wrapper">
          ...
          <ul class="right hide-on-med-and-down">
            ...
            <li><a href="catalog_buku.php">Catalog</a></li>
      ...
      <div class="row">
        ...
        <div class="col s12 m6">
          <div class="card">
            <div class="card-image">
              ...
              <span class="card-title blue darken-2">
                <b>Master Data</b>
              </span>
            </div>
            <div class="card-content">
        ...
        <div class="col s12 m6">
          <div class="card">
            ...
            <div class="card-action">
              <a href="transaksi.php" class="green-text darken-2">Masuk Ke Halaman Transaksi Data</a>
            </div>
          </div>
        </div>
        <div class="col s12 m6">
