...
<html>
  ...
  <body class="scrollspy" id="homes">
    ...
    <ul id="masterdata2s" class="dropdown-content">
      <li><a class="white-text indigo darken-1 center"><!-- <i class="material-icons">assessment</i> -->Master Data</a></li>
      <li class="divider"></li>
...
<section class="grey lighten-5" id="input_data_user">
  <div class="container">
      ...
      <form action="cari_data_buku.php" method="post">
        <div class="col m8 offset-m2 s12">
          <div class="input-field col m8 offset-m2 s12">
            ...
            <input placeholder="Kata Kunci ..." id="first_name" name="katakunci" type="text" autofocus autocomplete="off" class="validate">
    ...
    <div class="row">
      ...
      <br><br>
      <!-- navigasi pagination -->
      <!-- pengulangan dalam bentuk template -->
      <?php if($halamanaktif > 1) : ?>
      <a href="?halaman=<?php echo$halamanaktif - 1; ?>">&laquo;</a>
      <?php endif; ?>
      <?php for($i = 1 ; $i <= $jumlhaperhalaman; $i++) : ?>
      <?php if( $i == $halamanaktif ) : ?>
      <a
      href="?halaman=<?php echo $i; ?>" style="font-weight: bold; color: magenta" ><?php echo $i;?></a>
      <?php else : ?>
      <a href="?halaman=<?php echo $i; ?>"><?php echo$i; ?></a>
      <?php endif; ?>
      <?php endfor; ?>
      <?php if($halamanaktif < $jumlhaperhalaman) : ?>
